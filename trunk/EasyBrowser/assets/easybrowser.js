...
function setTitle(index, collapse, data) {
...
function setButton(data1, data2, data3) {
	document.getElementById('edit_home').innerHTML = data1;
	document.getElementById('delete_selected').innerHTML = data2;
	document.getElementById('cancel_edit').innerHTML = data3;
}
