        ...
        var imgTool = function (on, maxImg, viewImg) {
            var width = 0,
                ...
                tool = function () {
                    ...
                    var html = '<div class="well artZoomBox"><div class="tool"><a class="hideImg" href="#" title="\u6536\u8D77">\u6536\u8D77</a> | <a class="imgLeft" href="#" title="\u5411\u53F3\u8F6C">\u5411\u53F3\u8F6C</a> | <a class="imgRight" href="#" title="\u5411\u5DE6\u8F6C">\u5411\u5DE6\u8F6C</a> | <a class="viewImg" href="' + viewImg + '" title="\u67E5\u770B\u539F\u56FE">\u67E5\u770B\u539F\u56FE</a></div><a href="' + viewImg + '" class="maxImgLink"> <img class="maxImg" width="' + width + '" height="' + height + '" maxWidth="' + maxWidth + '" raw_width="' + raw_width + '" raw_height="' + raw_height + '" src="' + maxImg + '" /></a></div>';
                    on.after(html);
